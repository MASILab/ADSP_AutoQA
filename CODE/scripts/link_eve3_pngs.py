...
def pa():
    parser = argparse.ArgumentParser(description='Link eve3 pngs')
...
cmd = "find {} -mindepth 4 -maxdepth 4 -wholename '*WMAtlasEVE3*/Atlas_JHU_MNI_SS_WMPM_Type-III.png'".format(args.deriv_path)
